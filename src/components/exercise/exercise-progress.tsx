    ...
    useEffect(() => {
        const fetchAllExerciseWorkouts = async () => {
            ...
            try {
                ...
                console.error(
                    'Error fetching exercise workout data for charts:',
                    error,
                );
            } finally {
                setIsLoading(false);
    ...
    const getAvailableMetrics = () => {
        ...
        // For bodyweight exercises, show weight metrics (since bodyweight is included)
            ...
            return [
                {
                    value: 'maxWeight',
                    label: 'Max Weight (with Bodyweight)',
                    icon: Weight,
                },
                {
                    value: 'totalWeight',
                    label: 'Total Weight (with Bodyweight)',
                    icon: Weight,
                },
                { value: 'maxReps', label: 'Max Reps', icon: Repeat },
                { value: 'totalReps', label: 'Total Reps', icon: Repeat },
        ...
        // For bodyweight with assistance, show weight metrics (assistance is subtracted)
            ...
            return [
                {
                    value: 'maxWeight',
                    label: 'Max Weight (Bodyweight - Assistance)',
                    icon: Weight,
                },
                {
                    value: 'totalWeight',
                    label: 'Total Weight (Bodyweight - Assistance)',
                    icon: Weight,
                },
                { value: 'maxReps', label: 'Max Reps', icon: Repeat },
                { value: 'totalReps', label: 'Total Reps', icon: Repeat },
                ...
                <div className="flex flex-col items-center space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-muted-foreground max-w-md">
                            Complete some workouts with this exercise to see
                            your progress charts and analytics.
                        </p>
                    </div>
                </div>
            </div>
