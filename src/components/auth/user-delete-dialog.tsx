    ...
    return (
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            <DialogTrigger asChild>
                <Button
                    variant="destructive"
                    className="w-full sm:w-auto hover:cursor-pointer hover:opacity-80 transition-opacity duration-200 ease-in-out"
                >
            ...
            <DialogContent className="sm:max-w-[425px] bg-white text-black dark:bg-slate-900 dark:text-white">
                <DialogHeader>
                    <DialogTitle className="flex items-center text-destructive">
                        <AlertTriangle className="h-5 w-5 mr-2" /> Delete Your
                        Account
                    </DialogTitle>
                    <DialogDescription>
                ...
                <div className="grid gap-4 py-4">
                    <div className="space-y-2">
                        <p className="text-sm font-medium">
                            ...
                            <span className="font-bold">{userEmail}</span> to
                            confirm
                        </p>
                        <Input
                            value={confirmation}
                    ...
                    <div className="text-sm text-muted-foreground">
                        <p>
                            All your workouts, exercises, and personal data will
