                        ...
                        <AreaChart data={chartData} margin={{ top: 20, right: 30, left: 20, bottom: 20 }}>
                            <defs>
                                <linearGradient id="weightGradient" x1="0" y1="0" x2="0" y2="1">
                                    <stop offset="5%" stopColor={isDarkMode ? '#22d3ee' : '#0ea5e9'} stopOpacity={0.3} />
                                    <stop offset="95%" stopColor={isDarkMode ? '#22d3ee' : '#0ea5e9'} stopOpacity={0.05} />
                                </linearGradient>
                            </defs>
                            <CartesianGrid strokeDasharray="3 3" stroke={isDarkMode ? '#334155' : '#e2e8f0'} />
                            <XAxis dataKey="formattedDate" stroke={isDarkMode ? '#94a3b8' : '#64748b'} fontSize={12} fontWeight={500} />
