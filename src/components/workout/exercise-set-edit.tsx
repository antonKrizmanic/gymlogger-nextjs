...
export function ExerciseSetEdit({
    set,
    index,
    exerciseType,
    previousSet,
    ...
    return (
        <div className="space-y-2 p-4 rounded-lg bg-gradient-to-r from-muted/80 to-muted/40 border border-muted-foreground/10 shadow-sm">
