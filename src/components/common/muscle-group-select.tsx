...
export const MuscleGroupSelect = memo(function MuscleGroupSelect({
    ...
    useEffect(() => {
        const fetchMuscleGroups = async () => {
            ...
            const options = showAllOption
                ? [
                      { id: ALL_GROUPS_ID, name: 'All Muscle Groups' },
                      ...muscleGroups,
                  ]
                : showMessageOption
                  ? [
                        { id: SELECT_MESSAGE_ID, name: 'Select Muscle Group' },
                        ...muscleGroups,
                    ]
                  : muscleGroups;
            setGroups(options);
        ...
        fetchMuscleGroups();
    }, [showAllOption, showMessageOption, ALL_GROUPS_ID, SELECT_MESSAGE_ID]);
    ...
    return (
        <IconSelect
            ...
            label="Muscle Group"
            placeholder={
                showMessageOption ? 'Select Muscle Group' : 'All Muscle Groups'
            }
            value={selectValue}
