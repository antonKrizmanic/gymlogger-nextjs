...
const logTypeOptions = [
    {
        value: ExerciseLogType.WeightAndReps.toString(),
    ...
    {
        value: ExerciseLogType.BodyWeightWithAdditionalWeight.toString(),
        label: 'Body Weight + Additional',
    },
    {
        value: ExerciseLogType.BodyWeightWithAssistance.toString(),
...
export function LogTypeSelect({
    ...
    const options = showAllOption
        ? [
              {
                  value: ExerciseLogType.Unknown.toString(),
                  label: 'All Log Types',
              },
              ...logTypeOptions,
          ]
    ...
    const selectValue =
        selectedLogType === ExerciseLogType.Unknown && showAllOption
