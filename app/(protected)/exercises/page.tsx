...
const ExerciseContent = () => {
    ...
    return <ExerciseIndex isFilterOpen={isFilterOpen} />;
};
                ...
                <div className="space-y-6 pb-8">
                    <div className="space-y-4">
                        ...
                        <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl">
                            Discover and master new exercises. Build your
                            perfect workout routine with our comprehensive
                            exercise database and tracking tools.
                        </p>
                    </div>
