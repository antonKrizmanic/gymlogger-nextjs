		...
		<Container>
			{/* Hero Section */}
                        <div className="text-center space-y-4 mb-8">
                                ...
                                <div>
                                        <h1 className="type-heading-lg">Welcome, {user?.name || "User"}!</h1>
                                        <p className="type-body-md text-muted-foreground">Manage your account settings and preferences</p>
                                </div>
                        </div>
                                ...
                                <Card className="border-2">
                                        <CardHeader className="pb-4">
                                                <CardTitle className="flex items-center gap-3">
                                                        ...
                                                        <span className="type-heading-sm">Personal Information</span>
                                                </CardTitle>
                                                ...
                                                <div className="space-y-4">
                                                        <div className="flex items-center space-x-4 p-4 bg-muted/30 rounded-lg border">
                                                                ...
                                                                <div className="flex-1">
                                                                        <p className="type-label text-muted-foreground">Full Name</p>
                                                                        <p className="type-body-lg text-foreground font-semibold">{user?.name || "Not provided"}</p>
                                                                </div>
                                                        </div>
                                                        <div className="flex items-start space-x-4 p-4 bg-muted/30 rounded-lg border">
                                                                ...
                                                                <div className="flex-1 min-w-0">
                                                                        <p className="type-label text-muted-foreground">Email Address</p>
                                                                        <p className="type-body-lg text-foreground font-semibold break-all">{user?.email}</p>
                                                                </div>
                                                        </div>
                                                </div>
                                        </CardContent>
                                ...
                                <Card className="border-2">
                                        <CardHeader className="pb-4">
                                                <CardTitle className="flex items-center gap-3">
                                                        ...
                                                        <span className="type-heading-sm">Account Management</span>
                                                </CardTitle>
                                                ...
                                                <div className="space-y-4">
                                                        <div className="p-4 bg-destructive/5 border-2 border-destructive/20 rounded-lg">
                                                                <div className="flex items-start space-x-3">
                                                                        ...
                                                                        <div className="flex-1">
                                                                                <h3 className="type-heading-sm text-destructive mb-2">Danger Zone</h3>
