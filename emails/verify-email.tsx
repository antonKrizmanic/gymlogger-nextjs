        ...
        <Html>
            ...
            <Tailwind>
                <ContentCard>
                    ...
                    <Paragraph>
                        Before you start to use GymNotebook, you need to verify
                    ...
                    <Disclaimer>
                        This email was sent to you because you created an
                        account on{' '}
                        <span className="text-black">
                            {process.env.NEXT_PUBLIC_APP_NAME}
                        </span>
                        . If you didn't expect this confirmation, you can ignore
                        this email.
                    </Disclaimer>
                </ContentCard>
            </Tailwind>
